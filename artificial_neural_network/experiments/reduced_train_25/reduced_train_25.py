...
# Reduce training set
reduction_ratio = 0.25
reduced_size = int(len(X_train) * reduction_ratio)

X_train_reduced = X_train[:reduced_size]
y_train_reduced = y_train_cat[:reduced_size]
...
# Train the model
history = model.fit(X_train_reduced, y_train_reduced, epochs=20, batch_size=32, validation_split=0.2, verbose=1)
